...
export default function Item() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex">
        {/* Sidebar */}
        <aside className="w-96 bg-gray-50 border-r border-gray-200 h-screen overflow-y-auto px-6 py-8">
          {/* Thumbnail */}
          <div className="mb-8">
            <img
              src={item.url}
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-lg shadow p-4">
              ...
              <div className="mt-1 text-gray-800 font-medium">{slug}</div>
            </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative inline-flex flex-shrink-0 h-6 w-11 border-2 rounded-full transition-colors focus:outline-none ${
                    isPrivate ? 'bg-green-500 border-green-500' : 'bg-gray-200 border-gray-200'
                  }`}
                >
                  <span
