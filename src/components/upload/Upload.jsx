...
export default function UploadImages() {
  ...
  // generate unique id for select, new collection name input, and summary textarea
  const collectionSelectId = useId();
  const collectionNameInputId = useId();
  const collectionSummaryInputId = useId();
  ...
  return (
    ...
    >
      <h2 style={{ textAlign: "center", marginBottom: 24 }}>Upload Images</h2>
          ...
          <label htmlFor={collectionSelectId} style={{ display: "block", marginBottom: 4 }}>
            Collection
          </label>
          <select
      ...
      {isCreatingNew && (
        <div>
          <label htmlFor={collectionNameInputId} style={{ display: "block", marginBottom: 4 }}>
            New Collection Name
          </label>
          <input
          ...
          />
          <label htmlFor={collectionSummaryInputId} style={{ display: "block", marginBottom: 4 }}>
            Summary (optional)
          </label>
          <textarea
            id={collectionSummaryInputId}
